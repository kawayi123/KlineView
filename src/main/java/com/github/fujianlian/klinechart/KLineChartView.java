    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        if (array != null) {
            try {
                ...
                setTextColor(array.getColor(R.styleable.KLineChartView_kc_text_color, getColor(R.color.chart_white)));
                ...
                //kline 主背景
                setBackgroundColor(array.getColor(R.styleable.KLineChartView_kc_background_color, Color.parseColor("#000000")));
                setSelectPointColor(array.getColor(R.styleable.KLineChartView_kc_background_color, getColor(R.color.chart_point_bac)));

                setSelectedXLineColor(getColor(R.color.chart_line_color));
...
//                setGridLineColor(getColor(R.color.chart_ma5));
                //macd
                ...
                setSelectorBackgroundColor(array.getColor(R.styleable.KLineChartView_kc_selector_background_color, getColor(R.color.chart_selector_new)));
...
//        showLoading();
    ...
    public void setMainRangLine(boolean isLine) {
        mMainDraw.setRange(isLine);
        invalidate();
    }

    public void setKlineType(String klineType) {
        mMainDraw.setKlineType(klineType);
        invalidate();
    }
